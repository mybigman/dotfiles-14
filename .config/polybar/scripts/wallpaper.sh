...
dir="${XDG_PICTURES_DIR:-${HOME}/Franks/Wallpapers/000.jpg}"
unsplash_dir="${XDG_PICTURES_DIR:-${HOME}/Franks/Wallpapers}/000.jpg"
default="$dir/Franks/Wallpapers/000.jpg"
ultima="/home/ghost/Wallpapers/058.jpg"
modo="--bg-fill"
indice=0
i=0
